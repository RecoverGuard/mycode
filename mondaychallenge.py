...
first_name = mess['all'][5]['First']
last_name = mess['all'][5]['Last']
skill_level = mess['all'][5]['Skill Level']
spirit_animal = mess['all'][5]['Spirit Animal']
super_power = mess['all'][5]['Super Power']



print(f"My name is {first_name} {last_name} and my Spirit Animal is {spirit_animal}.")

print(f"My name is {first_name} {last_name} and my skill level is {skill_level}.")

print(f"My name is {first_name} {last_name} and my super power is {super_power}.")

#for x in dict.keys(First,Last):
 #   print(f"My name is {first_name} {last_name} and my Spirit Animal is {spirit_animal}.")


for x in mess["all"]:
    print('Name: ' + x["First"] + ' ' + x["Last"])
    print('Skill Level: ' + x["Skill Level"])
    print('Spirit animal: ' + x["Spirit Animal"])
    print('Super Power: ' + x["Super Power"])
    print()
